...
#slide[
  #paper(
    ...
    [Patrick Lewis et al.],
    2020,
    [Introduces RAG models that combine pre-trained parametric and non-parametric memory for language generation, using a dense vector index of Wikipedia accessed with a neural retriever.],
